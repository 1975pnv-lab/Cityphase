...
<section class="sec" id="s8" style="height:auto;min-height:100vh;padding:57px 0 0;overflow:visible">
  <div class="order-wrap">
    <div class="order-left rl"><div style="display:flex;flex-direction:column;gap:12px;margin-top:24px;margin-bottom:24px;"><div class="order-name-wrap">  <h2 class="order-name">12 Hours <span class="order-star">★</span></h2>  <span class="order-name-sub">длинный день — один выбор.</span></div><p class="order-tagline">Больше не нужно выбирать между статусом и комфортом.</p><p class="order-price-tag">15 900 ₽</p></div>

...
<div id="form" class="form-right rr"><h3 class="form-title">Первая партия — 200 единиц</h3><p class="form-sub">Каждый покупатель получает именной статус «Основатель #N из 200» и возможность влиять на разработку следующих продуктов CityPhase. Запись открыта до 25 августа. Оплата после подтверждения заявки.</p><div class="form-bar">  <div class="bar-track"><div class="bar-fill" id="barFill" style="width:0%"></div></div>  <span class="bar-txt" id="barTxt">осталось <span id="spotsLeft">200</span> мест</span></div><div class="urg">  <div><span class="urg-n" id="urgSpots">200</span><span class="urg-l">мест осталось</span></div>  <div><span class="urg-n">25 августа</span><span class="urg-l">дедлайн</span></div></div><div class="form-fields" id="ff">  <input class="fi" type="text" id="fn" placeholder="Ваше имя" required>  <input class="fi" type="email" id="fe" placeholder="Email" required>    <div class="frow" style="flex-direction:column;gap:16px;">
  ...
  <footer style="background:#0F2240;padding:56px 60px 32px;">
    <div class="f-cols" style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:48px;flex-wrap:wrap;gap:32px;"><div class="f-brand" style="flex:1;min-width:200px;">  <div style="font-family:'Raleway',sans-serif;font-size:15px;font-weight:500;letter-spacing:0.22em;color:#fff;margin-bottom:12px;">CITYPHASE</div>  <p style="font-size:13px;color:rgba(255,255,255,0.45);line-height:1.6;max-width:220px;">Деловая одежда для длинного дня. Право не выбирать между комфортом и статусом.</p></div><div class="f-nav" style="display:flex;gap:64px;flex-wrap:wrap;">  <div class="f-col" style="display:flex;flex-direction:column;gap:12px;">    <span style="font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:rgba(255,255,255,0.35);">Продукт</span>    <a href="/12-hours" style="font-size:13px;color:rgba(255,255,255,0.55);text-decoration:none;">12 Hours ★</a>    <a href="/technology" style="font-size:13px;color:rgba(255,255,255,0.55);text-decoration:none;">Ткань LYONEX</a>    <a href="/sizes" style="font-size:13px;color:rgba(255,255,255,0.55);text-decoration:none;">Каталог</a>  </div>  <div class="f-col" style="display:flex;flex-direction:column;gap:12px;">    <span style="font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:rgba(255,255,255,0.35);">Бренд</span>    <a href="/about" style="font-size:13px;color:rgba(255,255,255,0.55);text-decoration:none;">О бренде</a>    <a href="/about#how" style="font-size:13px;color:rgba(255,255,255,0.55);text-decoration:none;">Как мы делаем одежду</a>  </div>  <div class="f-col" style="display:flex;flex-direction:column;gap:12px;">    <span style="font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:rgba(255,255,255,0.35);">Контакты</span>    <a href="mailto:hello@cityphase.ru" style="font-size:13px;color:rgba(255,255,255,0.55);text-decoration:none;">hello@cityphase.ru</a>    <a href="https://t.me/cityphase_ru" style="font-size:13px;color:rgba(255,255,255,0.55);text-decoration:none;">Telegram @cityphase_ru</a>  </div></div>
    </div>

...
.order-left{padding:60px 52px 40px;border-right:1px solid var(--mist);display:flex;flex-direction:column;justify-content:space-between}
.order-name{
...
<div style="margin-top:auto;padding-top:32px;border-top:1px solid var(--mist);">
        ...
        <p style="font-family:var(--body);font-size:13px;color:var(--ink);line-height:1.7;margin-bottom:8px;">Мы уверены в своём продукте. Поэтому даём вам 30 дней с момента получения — поносите, постирайте, возьмите в командировку.</p>
        <p style="font-family:var(--body);font-size:13px;color:var(--ink);line-height:1.7;">Если не подойдёт — напишите на <a href="mailto:hello@cityphase.ru" style="color:var(--navy);">hello@cityphase.ru</a>. Вернём полную стоимость в течение 3 рабочих дней после получения его нами. Без объяснений и без бюрократии.</p>
      </div>
    </div>

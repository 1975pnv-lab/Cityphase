...
.order-left{padding:60px 52px 40px;border-right:1px solid var(--mist);display:flex;flex-direction:column;justify-content:center;gap:24px}
.order-name{
...
<div style="padding-top:32px;border-top:1px solid var(--mist);">

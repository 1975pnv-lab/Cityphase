...
.order-name-wrap{display:flex;align-items:center;gap:20px;margin-bottom:8px;flex-wrap:wrap;justify-content:flex-start}
.order-name-sub{
  font-family:var(--display);font-size:11px;font-weight:500;
  letter-spacing:4px;text-transform:uppercase;color:var(--ink);
}
...
@media(max-width:900px){
  ...
  .whom-right{padding-bottom:0}
  .scenario:last-child{border-bottom:none}
  .prop-list{padding-bottom:0}
...
<section class="sec" id="s2">
  <div class="whom-banner rl">
    ...
    <p style="font-family:var(--body);font-size:clamp(15px,1.4vw,18px);font-weight:400;color:#fff;line-height:1.6;margin-top:auto;padding-bottom:48px;">Статус или комфорт? И то и другое!</p>
  </div>
...
<section class="sec" id="s4">
  <h2 class="sh r" style="padding-top:clamp(64px,16vh,160px);margin-bottom:clamp(32px,8vh,80px);">Трикотажная рубашка <em style="color:var(--teal)">12 Hours ★</em></h2>
...
<section class="sec" id="s7" style="height:auto;overflow:visible">
  ...
  <div class="faq-list r">
    <div class="faq-item"><button class="faq-q" onclick="toggleFaq(this)">Когда будет готова рубашка? <span class="faq-arr">+</span></button><div class="faq-a">Первая партия — 200 единиц. Производство планируется завершить к сентябрю 2026. За всеми этапами производства и доставки можно следить в нашем Телеграм-канале: <a href="https://telegram.me/cityphase_ru" style="color:var(--navy);text-decoration:none;border-bottom:1px solid var(--mist)">@cityphase_ru</a>. После поступления товара на склад вы получите счёт на оплату.</div>
    </div>
...
<div id="form" class="form-right rr"><h3 class="form-title">Первая партия — 200 единиц</h3><p class="form-sub">Каждый покупатель получает именной статус «Основатель #N из 200» и возможность влиять на разработку следующих продуктов CityPhase. Запись открыта до 25 августа. Оплата после подтверждения заявки.</p><div class="form-bar">  <div class="bar-track"><div class="bar-fill" id="barFill" style="width:0%"></div></div>  <span class="bar-txt" id="barTxt">осталось <span id="spotsLeft">200</span> мест</span></div><div class="urg">  <div><span class="urg-n" id="urgSpots">200</span><span class="urg-l">мест осталось</span></div>  <div><span class="urg-n">25 августа</span><span class="urg-l">дедлайн</span></div></div><div class="form-fields" id="ff">  <input class="fi" type="text" id="fn" placeholder="Ваше имя" required>  <input class="fi" type="email" id="fe" placeholder="Email" required>    <div class="frow" style="flex-direction:column;gap:16px;">
  ...
  </div>  <a href="/sizes" class="form-sizes-ref" target="_blank">Как определить размер →</a>  <input class="fi" type="text" id="fpromo" placeholder="Промокод (если есть)">  <button class="fsub" id="fsubmit" onclick="send()">Предзаказ</button>  <!-- TODO: EmailJS — emailjs.send('service','template',{name,email,size,color,promo}) -->  <p class="fpriv">Нажимая кнопку, вы соглашаетесь на получение письма с подтверждением заявки.</p>  <div class="tg-cta">    <a href="https://telegram.me/cityphase_ru" class="tg-link" target="_blank">      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm4.93 7.03l-1.69 7.96c-.13.58-.47.72-.95.45l-2.63-1.94-1.27 1.22c-.14.14-.26.26-.53.26l.19-2.68 4.87-4.4c.21-.19-.05-.29-.33-.1L8.42 14.09l-2.59-.81c-.56-.18-.57-.56.12-.83l10.12-3.9c.47-.17.88.11.76.82z" fill="currentColor"/></svg>      Следите за нашим проектом в Телеграмм    </a>  </div></div><div class="form-ok" id="fok">Заявка принята. Мы пришлём письмо с вашим именным номером и деталями оплаты. Добро пожаловать в число первых.</div>
    </div>
    <div class="g-mob">
        <p style="font-family:var(--display);font-size:11px;font-weight:500;letter-spacing:0.14em;text-transform:uppercase;color:var(--teal);margin-bottom:12px;">Расширенная гарантия</p>
        <p style="font-family:var(--body);font-size:13px;color:var(--ink);line-height:1.7;">Мы уверены в своём продукте. Поэтому даём вам 30 дней с момента получения, чтобы убедиться в этом самому — примерьте, проверьте посадку и качество. Если не подошло — напишите на hello@cityphase.ru. Вернём полную стоимость при возврате товара с сохранёнными этикетками и упаковкой в течение 3 рабочих дней после получения его нами.</p>
  ...
  <footer style="background:#0F2240;padding:56px 60px 32px;">
    <div class="f-cols" style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:48px;flex-wrap:wrap;gap:32px;"><div class="f-brand" style="flex:1;min-width:200px;">  <div style="font-family:'Raleway',sans-serif;font-size:15px;font-weight:500;letter-spacing:0.22em;color:#fff;margin-bottom:12px;">CITYPHASE</div>  <p style="font-size:13px;color:rgba(255,255,255,0.45);line-height:1.6;max-width:220px;">Деловая одежда для длинного дня. Право не выбирать между комфортом и статусом.</p></div><div class="f-nav" style="display:flex;gap:64px;flex-wrap:wrap;">  <div class="f-col" style="display:flex;flex-direction:column;gap:12px;">    <span style="font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:rgba(255,255,255,0.35);">Продукт</span>    <a href="/12-hours" style="font-size:13px;color:rgba(255,255,255,0.55);text-decoration:none;">12 Hours ★</a>    <a href="/technology" style="font-size:13px;color:rgba(255,255,255,0.55);text-decoration:none;">Ткань LYONEX</a>  </div>  <div class="f-col" style="display:flex;flex-direction:column;gap:12px;">    <span style="font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:rgba(255,255,255,0.35);">Бренд</span>    <a href="/about" style="font-size:13px;color:rgba(255,255,255,0.55);text-decoration:none;">О бренде</a>  </div>  <div class="f-col" style="display:flex;flex-direction:column;gap:12px;">    <span style="font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:rgba(255,255,255,0.35);">Контакты</span>    <a href="mailto:hello@cityphase.ru" style="font-size:13px;color:rgba(255,255,255,0.55);text-decoration:none;">hello@cityphase.ru</a>    <a href="https://telegram.me/cityphase_ru" style="font-size:13px;color:rgba(255,255,255,0.55);text-decoration:none;">Telegram @cityphase_ru</a>  </div></div>
    </div>
...
function checkSoldOutAll() {
  ...
  form.innerHTML = '<p style="font-size:16px;color:var(--navy);font-weight:600;margin-bottom:8px;">Первая партия распродана</p>'
    + '<p style="font-size:14px;color:var(--ink);line-height:1.6;">Все 200 рубашек нашли своих владельцев. Подпишитесь на <a href="https://telegram.me/cityphase_ru" target="_blank" style="color:var(--navy);">Telegram-канал</a> — там объявим о следующей партии.</p>';
}

      ...
      <section style={{ background: '#fff', padding: '80px 40px' }}>
        <div style={{ maxWidth: 640, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 16, color: '#3D4558', lineHeight: 1.7, marginBottom: 20 }}>
            Деловая одежда давно не менялась. Она мнётся, в ней бывает жарко, она стесняет движения. Мы задали себе вопрос: что если подойти к ней как к инженерной задаче — где каждое решение обосновано конкретной проблемой?
          </p>
          <p style={{ fontSize: 16, color: '#3D4558', lineHeight: 1.7 }}>
            Так появился CityPhase. Мы начали с самого сложного сценария — длинного рабочего дня. Перелёт, встреча, переговоры, ужин. Одна рубашка с утра до вечера, и в конце дня она выглядит так же, как в начале.
          </p>
        </div>
      </section>

      ...
      <section className="hero-band" style={{ background: 'linear-gradient(135deg,#0a1628 0%,#0d1f3c 60%,#0f2a4a 100%)', padding: '80px 40px' }}>
        ...
        <div style={{ maxWidth: 640 }}>
          ...
          <p style={{ fontSize: 17, color: 'rgba(255,255,255,0.75)', lineHeight: 1.65, maxWidth: 620 }}>
            Деловая одежда для длинного рабочего дня. Выглядит достойно и утром, и вечером. Каждое решение в ней обосновано. Начинаем с трикотажной рубашки 12 Hours.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: '#fff', padding: '80px 40px' }}>
        <div style={{ maxWidth: 640, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 16, color: '#3D4558', lineHeight: 1.7 }}>
            Длинный рабочий день — не самый простой сценарий. Перелёт, встреча, переговоры, ужин. Одна рубашка с утра до вечера, и в конце дня она должна выглядеть так же, как и в начале. Мы решили, что начнём с этого.
          </p>
        </div>
      </section>

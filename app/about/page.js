      ...
      <section style={{ background: '#fff', padding: '80px 40px' }}>
        <div style={{ maxWidth: 640, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 16, color: '#3D4558', lineHeight: 1.7 }}>
            Длинный рабочий день — не самый простой сценарий. Перелёт, встреча, переговоры, ужин. Одна рубашка с утра до вечера, и в конце дня она выглядит так же, как в начале.
          </p>
        </div>
      </section>
